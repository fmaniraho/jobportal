 ...
 */
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo web_root; ?>">Alight Job Portal</a>
        ...
        <div class="row mb-5">
        	<div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <p>In this challenge, you have the flexibility to choose whether to work on the frontend, the backend, or both.</p>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+250788834002</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">JoselyceA@wearealight.org</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
