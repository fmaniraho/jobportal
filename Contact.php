    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+250788834002</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@yoursite.com">JoselyceA@wearealight.org</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">wearealight.org</a></p>
          </div>
        </div>
